...
for datatype in ['train', 'val', 'test']:
    ...
    with open('/Users/wanghaoming/Public/cug_graduation_project/Code/LearningToCompare_FSL/datas/miniImagenet/'+ datatype + '.csv', 'r') as f:
        ...
        for i, row in enumerate(reader):
            ...
            if label != last_label:
                ...
                last_label = label
            os.system('cp /Users/wanghaoming/Public/cug_graduation_project/Code/LearningToCompare_FSL/datas/miniImagenet/images/' + image_name + ' ' + cur_dir)
